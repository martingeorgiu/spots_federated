...
import flwr as fl
import numpy as np
from flwr.common import FitRes, Parameters, Scalar, Metrics, parameters_to_ndarrays
...
class SaveModelStrategy(FedAvg):
    ...
    def aggregate_fit(
        ...
        print(f"aggregate_fitffffffffff ${results}")
...
def weighted_average(metrics: List[Tuple[int, Metrics]]) -> Metrics:
    print(f"weighted_averageeeeeeeeeeeeeeeee {metrics}")
