...
class HAM10000DataModule(pl.LightningDataModule):
    ...
    def train_dataloader(self):
        ...
        return DataLoader(self.ham_train, batch_size=self.batch_size, num_workers=9)

    def val_dataloader(self):
        # val_transform = transforms.Compose([transforms.Resize((self.input_size,self.input_size)), transforms.ToTensor()])
        return DataLoader(self.ham_val, batch_size=self.batch_size, num_workers=9)

    def test_dataloader(self):
        return DataLoader(self.ham_test, batch_size=self.batch_size, num_workers=9)
